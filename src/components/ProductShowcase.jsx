...
import { productHighlights } from '../data/content.js';
      ...
      <div className="container product-showcase__layout">
        ...
        <div className="product-showcase__content">
          <ScrollReveal>
            ...
            <p>
              برای هر پروژه چند مدل چمن با تراکم و ارتفاع متفاوت پیشنهاد می‌شود تا بین
              بودجه، ظاهر، نرمی و دوام بهترین تعادل را داشته باشید.
            </p>
          </ScrollReveal>
